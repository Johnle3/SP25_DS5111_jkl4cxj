...
import pandas as pd
import pytest
import bin.normalize_csv  # assuming your script is in bin/ and named normalize_csv.py

def test_file_not_exist():
    with pytest.raises(AssertionError):
        bin.normalize_csv.normalize_csv.normalize_csv("non_existent_file.csv")
...
def test_output_file_creation(tmp_path):
    ...
    bin.normalize_csv.normalize_csv.normalize_csv(str(test_input))
